...
$__System.register("2", [], function(exports_1, context_1) {
  ...
  return {
    setters: [],
    execute: function() {
      GreetingFactory = (function() {
        function GreetingFactory() {}
        GreetingFactory.make = function(name) {
          return "Hello, " + name;
        };
        return GreetingFactory;
      }());
      exports_1("GreetingFactory", GreetingFactory);
    }
  };
});
...
$__System.register("1", ["2"], function(exports_1, context_1) {
  ...
  var __moduleName = context_1 && context_1.id;
  return {
    setters: [function(GreetingFactory_1_1) {
      exports_1({"GreetingFactory": GreetingFactory_1_1["GreetingFactory"]});
    }],
    execute: function() {}
  };
});
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    ...
    TypeScriptJspmUmdSeed = factory();
});
//# sourceMappingURL=typescript-jspm-umd-seed.js.map